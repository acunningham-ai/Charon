...
- ✅ 4 always-fire rules + 13 path-conditioned rules
...
- ✅ 52 slash commands across reporting / security / the research→compose pipeline / retrieval (`/recall`, `/find-tensions`) / thinking (`/grill`, `/handoff`) / workflow / hygiene + the Cerberus suite
...
- ✅ Test suite — 16 LLM-behaviour scenarios + 27 automated deterministic checks
